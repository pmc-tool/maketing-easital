...
enum EntityEnum: string
{
    ...
    case SEEDANCE_1_LITE_TTV  = 'bytedance/seedance/v1/lite/text-to-video';
    case SEEDANCE_1_LITE_ITV  = 'bytedance/seedance/v1/lite/image-to-video';
    case SEEDANCE_1_PRO_TTV   = 'bytedance/seedance/v1/pro/text-to-video';
    case SEEDANCE_1_PRO_ITV   = 'bytedance/seedance/v1/pro/image-to-video';
    case SEEDANCE_1_5_PRO_TTV = 'bytedance/seedance/v1.5/pro/text-to-video';
    case SEEDANCE_1_5_PRO_ITV = 'bytedance/seedance/v1.5/pro/image-to-video';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::SEEDANCE_1_LITE_TTV                    => __('Seedance 1.0 Lite Text to Video'),
            self::SEEDANCE_1_LITE_ITV                    => __('Seedance 1.0 Lite Image to Video'),
            self::SEEDANCE_1_PRO_TTV                     => __('Seedance 1.0 Pro Text to Video'),
            self::SEEDANCE_1_PRO_ITV                     => __('Seedance 1.0 Pro Image to Video'),
            self::SEEDANCE_1_5_PRO_TTV                   => __('Seedance 1.5 Pro Text to Video'),
            self::SEEDANCE_1_5_PRO_ITV                   => __('Seedance 1.5 Pro Image to Video'),
    ...
    public function engine(): EngineEnum
    {
        return match ($this) {
            ...
            self::SEEDANCE_1_LITE_TTV, self::SEEDANCE_1_LITE_ITV, self::SEEDANCE_1_PRO_TTV, self::SEEDANCE_1_PRO_ITV, self::SEEDANCE_1_5_PRO_TTV, self::SEEDANCE_1_5_PRO_ITV,
            ...
            self::FLUX_2_FLEX, self::FLUX_2_FLEX_EDIT, self::GROK_IMAGINE_IMAGE, self::GROK_IMAGINE_IMAGE_EDIT, self::GROK_IMAGINE_VIDEO_TTV, self::GROK_IMAGINE_VIDEO_ITV => EngineEnum::FAL_AI,
            // Creatify
    ...
    public function driverClass(): string
    {
        return match ($this) {
            ...
            self::KLING_2_6_STANDARD_MOTION_CONTROL      => FalAI\Kling26Pro\KlingV26StandardMotionControlDriver::class,
            self::KLING_3_PRO_TTV                        => FalAI\Kling3\KlingV3ProTTVDriver::class,
            self::KLING_3_PRO_ITV                        => FalAI\Kling3\KlingV3ProITVDriver::class,
            self::KLING_3_STANDARD_TTV                   => FalAI\Kling3\KlingV3StandardTTVDriver::class,
            self::KLING_3_STANDARD_ITV                   => FalAI\Kling3\KlingV3StandardITVDriver::class,
            ...
            self::SEEDANCE_1_LITE_TTV                    => FalAI\Seedance\Seedance1LiteTTVDriver::class,
            self::SEEDANCE_1_LITE_ITV                    => FalAI\Seedance\Seedance1LiteITVDriver::class,
            self::SEEDANCE_1_PRO_TTV                     => FalAI\Seedance\Seedance1ProTTVDriver::class,
            self::SEEDANCE_1_PRO_ITV                     => FalAI\Seedance\Seedance1ProITVDriver::class,
            self::SEEDANCE_1_5_PRO_TTV                   => FalAI\Seedance\Seedance15ProTTVDriver::class,
            self::SEEDANCE_1_5_PRO_ITV                   => FalAI\Seedance\Seedance15ProITVDriver::class,
    ...
    public function unitPrice(): float
    {
        return match ($this) {
            ...
            self::FLUX_PRO_KONTEXT_TEXT_TO_IMAGE, self::FLUX_PRO_KONTEXT, self::FLUX_PRO, self::FLUX_2_FLEX, self::FLUX_2_FLEX_EDIT, self::GROK_IMAGINE_IMAGE, self::GROK_IMAGINE_IMAGE_EDIT => 0.4,
            ...
            self::KLING, self::KLING_2_1, self::KLING_IMAGE, self::LUMA_DREAM_MACHINE, self::HAIPER, self::MINIMAX, self::GROK_IMAGINE_VIDEO_TTV, self::GROK_IMAGINE_VIDEO_ITV, self::SEEDANCE_1_LITE_TTV, self::SEEDANCE_1_LITE_ITV, self::SEEDANCE_1_PRO_TTV, self::SEEDANCE_1_PRO_ITV, self::SEEDANCE_1_5_PRO_TTV, self::SEEDANCE_1_5_PRO_ITV => 0.5,
            self::KLING_2_6_PRO_TTV, self::KLING_2_6_PRO_ITV, self::KLING_2_6_PRO_MOTION_CONTROL, self::KLING_2_6_STANDARD_MOTION_CONTROL => 1.4,
            self::KLING_3_PRO_TTV, self::KLING_3_PRO_ITV, self::KLING_3_STANDARD_TTV, self::KLING_3_STANDARD_ITV => 1.4,
            self::IDEOGRAM => 0.6,
