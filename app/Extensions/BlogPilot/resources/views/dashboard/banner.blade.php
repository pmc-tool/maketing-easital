@php
    $banner_bg_light = asset('vendor/blogpilot/images/img-4.jpg');
    $banner_bg_dark = asset('vendor/blogpilot/images/img-4-dark.png');
@endphp
...
<div
    class="blogpilot-banner mb-10 flex flex-wrap items-center rounded-2xl bg-[url('{{ $banner_bg_light }}')] bg-cover bg-top px-5 dark:bg-white/[3%] dark:bg-[url('{{ $banner_bg_dark }}')] lg:px-12"
>
        ...
        >
            ...
            >
                <x-number-counter
                    ...
                    id="blogpilot-pending-posts-counter"
            ...
            <span class="flex grow items-center justify-between gap-3">
                <span class="m-0 flex items-center gap-3">
                    ...
                    <template x-if="!showReadyProgressText">
                        <span>{{ __('Post generation done.') }}</span>
                    </template>
                </span>
            </span>
        </a>
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
            <div>
                <x-number-counter
                    ...
                    id="blogpilot-scheduled-posts-counter"
    ...
    <div class="flex w-full justify-center max-lg:order-first lg:w-1/2">
        <video
            ...
            width="1200"
            height="1050"
            src="{{ asset('vendor/blogpilot/videos/banner-video.mp4') }}"
            autoplay
            playsinline
            muted
            loop
        ...
        <video
            ...
            width="1200"
            height="1050"
            src="{{ asset('vendor/blogpilot/videos/banner-video-dark.mp4') }}"
            autoplay
            playsinline
            muted
            loop
