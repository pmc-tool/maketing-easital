<x-sidedrawer id="blogpilot-sidedrawer">
        ...
        <div class="max-h-[calc(100vh-4rem)] min-h-full overflow-y-auto">
            <div class="flex items-center justify-between gap-1 border-b px-6 py-5">
                <span class="text-[18px] font-medium text-heading-foreground">
                    <span
                        class="capitalize"
                        x-text="editingPost.publishing_type?.label ?? editingPost.publishing_type?.value ?? 'Post'"
                    >
                        @lang('Post')
                    </span>
                    <span
                    ...
                    <div
                        ...
                        x-data="{
                            ...
                            async handleFiles(event) {
                                ...
                                try {
                                    const response = await fetch('{{ route('dashboard.user.blogpilot.agent.api.upload-image') }}', {
                                        method: 'POST',
                                        headers: {
                    ...
                    >
                        ...
                        >
                            @foreach ($platforms as $platform)
                                @php
                                    $image = 'vendor/blogpilot/icons/' . $platform->platform . '.svg';
                                    $image_dark_version = 'vendor/blogpilot/icons/' . $platform->platform . '-light.svg';
