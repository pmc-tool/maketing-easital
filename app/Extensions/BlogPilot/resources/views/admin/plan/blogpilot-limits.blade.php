        ...
        <div class="col-12 col-md-6">
            <div class="rounded-xl border border-border/60 bg-muted/30 p-4">
                <x-form.group
                    ...
                    tooltip="{{ __('Maximum number of blog agents a customer can create') }}"
                    error="plan.blogpilot_limits.agents"
                >
                    <x-form.text
                        type="number"
                        min="-1"
                        step="1"
                        size="lg"
                        wire:model.number="plan.blogpilot_limits.agents"
        ...
        <div class="col-12 col-md-6">
            <div class="rounded-xl border border-border/60 bg-muted/30 p-4">
                <x-form.group
                    ...
                    tooltip="{{ __('Maximum number of blog posts generated per month across all agents') }}"
                    error="plan.blogpilot_limits.monthly_posts"
                >
                    <x-form.text
                        type="number"
                        min="-1"
                        step="1"
                        size="lg"
                        wire:model.number="plan.blogpilot_limits.monthly_posts"
