<div class="relative flex h-[--header-height] shrink-0 flex-wrap items-center gap-2.5 border-b px-4 xl:px-6">
    ...
    <div class="ms-auto flex gap-2">
        ...
        >
            ...
            >
                <ul>
                    <li>
                        <a
                            class='group flex items-center gap-2 rounded px-2.5 py-1.5 text-2xs font-medium transition hover:bg-foreground/5 cursor-pointer'
                            href="#"
        ...
        <x-button
            ...
            @click.prevent="dateRangeModalVisible = true"
            x-bind:class="{ 'bg-primary/10 text-primary': filters.dateRange.start || filters.dateRange.end }"
        >
    ...
    <div
        ...
        x-show="dateRangeModalVisible"
        x-cloak
        @click.self="dateRangeModalVisible = false"
        @keyup.escape.window="dateRangeModalVisible = false"
        x-transition
    >
        <div
            class="relative w-full max-w-md rounded-xl bg-background p-6 shadow-2xl border"
            @click.stop
        >
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold">{{ __('Filter by Date Range') }}</h3>
                <x-button
                    class="size-8 bg-foreground/5 hover:-translate-y-0"
                    size="none"
                    variant="none"
                    @click.prevent="dateRangeModalVisible = false"
                >
                    <x-tabler-x class="size-4" />
                </x-button>
            </div>
            ...
            <div class="mb-4">
                ...
                />
                <div
                    id="conversationsDatepickerContainer"
