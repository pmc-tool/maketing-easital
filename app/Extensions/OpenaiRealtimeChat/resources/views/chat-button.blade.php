...
@if (setting('realtime_voice_chat', 0))
    <div @class([
        'pointer-events-auto flex items-center max-md:w-full max-md:flex-col max-md:items-start max-md:gap-4' => $compact,
        ...
        <x-button
            ...
            @class([
                ...
                'md:bg-secondary md:text-secondary-foreground md:hover:bg-primary md:hover:text-primary-foreground max-md:justify-start max-md:rounded-lg max-md:px-2 max-md:py-1.5 max-md:w-full [&.active]:hover:bg-red-500 [&.active]:hover:text-white' => $compact,
