...
>
    ...
    <h2 class="mb-7 text-[21px] font-medium leading-[1.2em]">
        @lang('<span class="opacity-50">Hey 👋. I’m your AI Social Media Agent. From planning to publishing, I help you create, schedule, and</span> optimise social posts with intelligent performance insights.')
    </h2>
    ...
    <p class="text-[12px]">
        ...
        <a
            ...
            href="#"
        >
            @lang('Learn more about Social Media Agent')
        </a>
    </p>
</div>
