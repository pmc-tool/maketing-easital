...
<div x-data='socialMediaAgentImpressionsChart'>
	<x-card class:body="px-6">
		...
		<div
			class="min-h-56"
			id="social-media-agent-impressions-chart"
		></div>
	</x-card>
</div>
...
@push('script')
	<script>
		document.addEventListener('alpine:init', () => {
			Alpine.data('socialMediaAgentImpressionsChart', () => ({
				chartData: @json($chartData),
				activeFilter: "{{ $initialFilter }}",
				chart: null,
				chartEl: document.querySelector('#social-media-agent-impressions-chart'),
