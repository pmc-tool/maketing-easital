...
<div x-data='socialMediaAgentPublishedPostsChart'>
	<x-card class:body="px-6">
		...
		<div
			class="min-h-56"
			id="social-media-agent-published-posts-chart"
		></div>
	</x-card>
</div>
...
@push('script')
	<script>
		document.addEventListener('alpine:init', () => {
			Alpine.data('socialMediaAgentPublishedPostsChart', () => ({
				chartData: @json($chart_data),
				activeFilter: "{{ $initialFilter }}",
				chart: null,
				chartEl: document.querySelector('#social-media-agent-published-posts-chart'),
