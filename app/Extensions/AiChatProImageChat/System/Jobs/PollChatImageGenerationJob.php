...
class PollChatImageGenerationJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        $record = AiChatProImageModel::find($this->recordId);
        if (! $record) {
            return;
        }
    ...
    private function handleCompleted(AiChatProImageModel $record, array $result): void
    {
