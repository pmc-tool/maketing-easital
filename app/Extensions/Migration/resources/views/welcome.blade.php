...
@section('container')
    <div class="mx-auto w-4/5">
        <h4 class="mb-20 mt-0 font-body text-[26px]">{{ __('Welcome to Easital Migrator') }}</h4>
        <p class="mb-9 text-[75px] leading-none">🪄</p>
        <h1 class="mb-10 mt-0 font-body text-[45px]">{{ __('Let’s start.') }}</h1>
		<p class="mb-10 text-[20px]">{{ __('Thanks choosing Easital! You will be able to migrate your data in seconds and unlock the magic of AI. Let’s get you started!') }}</p>
