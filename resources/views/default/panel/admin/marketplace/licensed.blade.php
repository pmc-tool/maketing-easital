...
@section('content')
    ...
    src="{{ $item['icon'] ?? 'https://res.cloudinary.com/dwpoeyv1a/image/upload/w_53,h_53,c_fill,q_auto/marketplace/extensions/'.$item['slug'].'/icon.png' }}"
    width="53"
    height="53"
    alt="{{ $item['name'] }}"
    onerror="this.src='https://res.cloudinary.com/dwpoeyv1a/image/upload/v1758824847/marketplace/extensions/default-icon.png'"
>
                            <div class="grow">
