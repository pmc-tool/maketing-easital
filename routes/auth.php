...
Route::middleware('guest')->group(function () {
    ...
    // Social Login
    Route::get('github/redirect', [AuthenticationController::class, 'githubRedirect'])->name('login.github');
    Route::get('google/redirect', [AuthenticationController::class, 'googleRedirect'])->name('login.google');
    Route::get('twitter/redirect', [AuthenticationController::class, 'twitterRedirect'])->name('login.twitter');
    Route::get('/facebook/redirect', [AuthenticationController::class, 'facebookRedirect'])->name('login.facebook');
